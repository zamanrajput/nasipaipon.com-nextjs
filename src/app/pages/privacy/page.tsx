...
const PrivacyPolicy = () => {
  return (
    <div className="text-gray-200 px-5 sm:w-[70vw] w-[90vw] backdrop-blur-sm mx-auto mt-10 py-16 space-y-8">
      <h1 className="text-5xl font-bold text-shadow-custom2 text-center text-white">Privacy Policy</h1>
      ...
      <p>
        {" We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information inaccordance with this Privacy Policy. This Privacy Policy has been created with the help of the "}
        <a
  ...
  <li>
    <p>
      <strong>{"Application"}</strong> {"refers to Nasipaipon - Kitchen, the software program provided by the Company."}
    </p>
  </li>

  <li>
    <p>
      <strong>{"Company"}</strong>{"(referred to as either \"the Company\", \"We\", \"Us\" or \"Our\" in this Agreement) refers to Nasipaipon LLC, Kaula Lumpur."}
