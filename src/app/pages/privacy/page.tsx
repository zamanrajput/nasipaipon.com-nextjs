...
const PrivacyPolicy = () => {
  return (
    <div className="text-gray-400 px-5 sm:w-[70vw] w-[90vw] backdrop-blur-sm mx-auto mt-10 py-16 space-y-8">
      <h1 className="text-5xl text-center text-white">Privacy Policy</h1>

      <p className="text-center">Last updated: October 29, 2024</p>
      ...
      <h3 className="text-xl text-white">Interpretation</h3>
      ...
      <h3 className="text-xl text-white">Definitions</h3>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Nasipaipon - Kitchen, the
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Nasipaipon LLC, Kaula Lumpur.
          </p>
        </li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Nasipaipon, accessible from{" "}
            <a
              className="text-blue-400 underline"
              href="https://www.nasipaipon.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.nasipaipon.com
            </a>
          </p>
        </li>
      ...
      <h4 className="text-lg text-white">Personal Data</h4>
      ...
      <h4 className="text-lg text-white">Usage Data</h4>
      ...
      <h4 className="text-lg text-white">Tracking Technologies and Cookies</h4>
      ...
      <h3 className="text-xl text-white">Use of Your Personal Data</h3>
      ...
      <h3 className="text-xl text-white">Retention of Your Personal Data</h3>
      ...
      <h3 className="text-xl text-white">Transfer of Your Personal Data</h3>
      ...
      <h3 className="text-xl text-white">Delete Your Personal Data</h3>
      ...
      <h3 className="text-xl text-white">Disclosure of Your Personal Data</h3>
      ...
      <h4 className="text-lg text-white">Law enforcement</h4>
      ...
      <h4 className="text-lg text-white">Other legal requirements</h4>
      ...
      <h3 className="text-xl text-white">Security of Your Personal Data</h3>
      ...
      <h2 className="text-2xl text-white">Links to Other Websites</h2>
      ...
      <ul>
        <li>By email: nasipaiponcredentials@gmail.com</li>
      </ul>
    </div>
  );
};
